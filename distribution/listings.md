...
|---|---|---|---|---|---|
| 1 | Official MCP Registry | `io.github.asokore/statcite` | `cd distribution && ../.tools/mcp-publisher.exe login github` then `../.tools/mcp-publisher.exe publish` | No — push per release | 2026-08-08 (v1.8.1); 2026-08-10: v1.9.1 publish pending — registry JWT expired, device-flow re-auth initiated (owner click), publish immediately after |
